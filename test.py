...
class SampleAssistant(object):
    ...
    """
    csf = None
    def __init__(self, conversation_stream, channel, deadline_sec, conversation_stream_file):
        self.conversation_stream = conversation_stream_file
        self.conversation_stream_mic = conversation_stream
        self.conversation_stream_file = conversation_stream_file

        #csf = conversation_stream_file
    ...
    def converse(self):
        ...
        while True:
            ...
            if not continue_conversation:
                afile = audio_helpers.WaveSource(
                    open(iaud, 'rb'), 
                    sample_rate=audsw, 
                    sample_width=audsw
                )
...
def main(api_endpoint, credentials, verbose,
    ...
    with SampleAssistant(conversation_stream,
                         grpc_channel, grpc_deadline, conversation_stream_file) as assistant:
...
def fdetect():
    click.pause(info='LOOKING FOR A FACE OR WHATEVER...')
